...
const Order = () => {
  ...
  useEffect(() => {
    axios(`http://localhost:7000/products/${id}`).then(
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post("https://evening-river-57363.herokuapp.com/orders", data)
      .then((res) => {
    ...
    <Container>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Link to="/explore">
          ...
          className="btn btn-danger ms-2 my-3 py-2 fw-bold rounded-pill"
        />
        </Link>
      </form>
    </Container>
